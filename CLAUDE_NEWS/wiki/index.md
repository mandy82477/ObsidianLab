...
- [[feature-radar-archive-2026-06]] — 2026-06 功能詳細條目封存

---

## 💻 開發實務入口

只放**開發實務強相關**的頁面（怎麼做、裝什麼、選什麼）；產品動態與事件追蹤住各自的頁，經策展蒸餾到這幾頁——**升版前想知道會壞什麼**：[[feature-radar]]「⚠️ 升版風險」；版本與已知問題：[[entities/claude-code]]（兩者在 🛠️ 工具/功能 分頁）。工具的判斷（該裝哪個、證據多強）由社群工具目錄每週策展，每日抄錄進「興趣類別 skill 總覽」——讀者只需看總覽一頁。
...
| [[topics/anthropic-business]] | 💼 商業 | ongoing | Anthropic 商業健康度：IPO 敘事、雲端基建巨額協議、企業採用率、訂閱補貼、PMF 觀察；亦是**訓練資料著作權訴訟**（書籍和解案、Sony／Warner 音樂訴訟）的事實落點 |
